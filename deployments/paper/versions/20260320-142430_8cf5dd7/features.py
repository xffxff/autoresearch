...
def build_features(market: MarketBundle) -> pd.DataFrame:
    ...
    volatility_14d = hourly_returns.rolling(24 * 14, min_periods=24 * 3).std().fillna(0.0)
    volatility_30d = hourly_returns.rolling(24 * 30, min_periods=24 * 3).std().fillna(0.0)
