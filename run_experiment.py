        ...
        "windows": [
            {
                ...
                "btc_buy_hold_return": window.benchmark_net_return,
                "excess_return_vs_btc": window.net_return - window.benchmark_net_return,
                "max_drawdown": window.max_drawdown,
                "btc_max_drawdown": window.benchmark_max_drawdown,
